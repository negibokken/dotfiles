...
振り返り結果から CLAUDE.md に追加すべき内容が特定された場合：

1. **更新提案の提示**: 具体的な追記・修正内容を提示
2. **ユーザーへの確認**: `AskUserQuestion` ツールを使用して CLAUDE.md を更新するかどうかをユーザーに尋ねる
3. **承認後の反映**: ユーザーが承認した場合のみ CLAUDE.md を更新
